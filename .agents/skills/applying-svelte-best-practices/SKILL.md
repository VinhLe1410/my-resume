---
name: applying-svelte-best-practices
description: Guides Svelte 5 reactivity, events, snippets, and styling. Use when editing or reviewing Svelte components and reactive modules in this project.
---

Adapted from [Svelte's official skill](https://github.com/sveltejs/ai-tools/tree/a5a92c680ebe0d432593f4228a122cb59f5a0c74/tools/skills/svelte-core-bestpractices). MIT license: [../LICENSE](../LICENSE).
